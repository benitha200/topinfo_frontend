      ...
      <div className="min-h-screen bg-gray-50">
          ...
          <div className={`relative max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 text-center z-10 transition-all duration-1000 ${isVisible ? 'opacity-100 transform translate-y-0' : 'opacity-0 transform translate-y-10'}`}>
            <div className="bg-white/10 backdrop-blur-lg rounded-3xl p-12 border border-white/20 shadow-2xl">
              <h1 className="text-5xl md:text-6xl font-extrabold text-white mb-6 leading-tight tracking-tight">
                TopInfo <span className="text-sky-100">Membership Club</span>
              </h1>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24">
          <div className="grid md:grid-cols-2 gap-16 items-center">
            <div>
              <h2 className="text-4xl md:text-5xl font-bold text-gray-900 mb-6">Kuki Wakaba Umunyamuryango wa TopInfo Membership Club?</h2>
              ...
              <ul className="space-y-6">
                <li className="flex items-start">
                  <div className="bg-sky-100 p-2 rounded-full mr-4 mt-1">
                    <Percent className="text-sky-600" size={20} />
                  </div>
                  <div>
            ...
            <div className="bg-gradient-to-br from-sky-50 to-sky-50 rounded-2xl p-10 shadow-lg transform hover:rotate-1 transition-all duration-500 hover:shadow-xl">
              <div className="bg-white/70 backdrop-blur-md rounded-xl p-8 shadow-inner flex flex-col items-center">
                <div className="bg-sky-100 p-4 rounded-full mb-6 shadow-md">
                  <Gift className="text-sky-600" size={64} />
                </div>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-12">
              <div className="inline-block p-3 bg-sky-100 rounded-full mb-6 shadow-md transform hover:rotate-12 transition-transform duration-300">
                <CreditCard className="text-sky-600" size={36} />
              </div>
            ...
            <div className="flex flex-wrap justify-center gap-4 mb-12">
              <button
                ...
                className={`px-6 py-3 rounded-full font-medium transition-all duration-300 ${activeTab === 'benefits' ? 'bg-sky-500 text-white shadow-md' : 'bg-white text-gray-600 hover:bg-gray-50'}`}
              >
                Akamaro
              </button>
              <button
                onClick={() => setActiveTab('how-it-works')}
                className={`px-6 py-3 rounded-full font-medium transition-all duration-300 ${activeTab === 'how-it-works' ? 'bg-sky-500 text-white shadow-md' : 'bg-white text-gray-600 hover:bg-gray-50'}`}
              >
                Uko Bikorwa
              </button>
              <button
                onClick={() => setActiveTab('partners')}
                className={`px-6 py-3 rounded-full font-medium transition-all duration-300 ${activeTab === 'partners' ? 'bg-sky-500 text-white shadow-md' : 'bg-white text-gray-600 hover:bg-gray-50'}`}
              >
                Abafatanyabikorwa
              </button>
            </div>
                ...
                <div className="grid md:grid-cols-2 gap-8">
                  ...
                  <div className="bg-sky-50 p-6 rounded-xl">
                    ...
                    <div className="space-y-6">
                      <div>
                        <h4 className="font-bold text-sky-600 flex items-center mb-2">
                ...
                <div className="grid md:grid-cols-2 gap-8">
                  <div>
                    ...
                    <ol className="space-y-8">
                      <li className="flex">
                        <div className="bg-sky-100 rounded-full h-8 w-8 flex items-center justify-center text-sky-600 font-bold mr-4 flex-shrink-0 mt-1">1</div>
                        <div>
                      ...
                      <li className="flex">
                        <div className="bg-sky-100 rounded-full h-8 w-8 flex items-center justify-center text-sky-600 font-bold mr-4 flex-shrink-0 mt-1">2</div>
                        <div>
                      ...
                      <li className="flex">
                        <div className="bg-sky-100 rounded-full h-8 w-8 flex items-center justify-center text-sky-600 font-bold mr-4 flex-shrink-0 mt-1">3</div>
                        <div>
                      ...
                      <li className="flex">
                        <div className="bg-sky-100 rounded-full h-8 w-8 flex items-center justify-center text-sky-600 font-bold mr-4 flex-shrink-0 mt-1">4</div>
                        <div>
                  ...
                  <div className="bg-sky-50 p-6 rounded-xl">
                    ...
                    <div className="space-y-6">
                      <div className="bg-white p-4 rounded-lg shadow">
                        <h4 className="font-bold text-sky-600 mb-2">Urugero rw'umunyamuryango wa Silver:</h4>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-12">
              <div className="inline-block p-3 bg-sky-100 rounded-full mb-6 shadow-md">
                <Star className="text-sky-600" size={36} />
              </div>
            ...
            <div className="grid md:grid-cols-3 gap-6">
              <div className="bg-white p-8 rounded-2xl shadow-lg">
                ...
                <div className="flex items-center">
                  <div className="h-12 w-12 rounded-full bg-sky-100 flex items-center justify-center text-xl font-bold text-sky-600">JM</div>
                  <div className="ml-4">
              ...
              <div className="bg-white p-8 rounded-2xl shadow-lg">
                ...
                <div className="flex items-center">
                  <div className="h-12 w-12 rounded-full bg-sky-100 flex items-center justify-center text-xl font-bold text-sky-600">DI</div>
                  <div className="ml-4">
              ...
              <div className="bg-white p-8 rounded-2xl shadow-lg">
                ...
                <div className="flex items-center">
                  <div className="h-12 w-12 rounded-full bg-sky-100 flex items-center justify-center text-xl font-bold text-sky-600">EM</div>
                  <div className="ml-4">
        ...
        <div className="bg-gradient-to-br from-sky-600 to-sky-700 py-20">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <div className="flex flex-col sm:flex-row justify-center gap-6">
              <Link
                to="/discount-club/join"
                className="px-10 py-5 bg-white text-sky-600 rounded-xl hover:bg-sky-50 transition-all duration-300 text-lg font-bold shadow-xl hover:shadow-2xl flex items-center justify-center"
              >
                Iyandikishe Nonaha
              ...
              <Link
                ...
                className="px-10 py-5 bg-sky-500 text-white rounded-xl hover:bg-sky-600 transition-all duration-300 text-lg font-bold shadow-xl hover:shadow-2xl flex items-center justify-center"
              >
                Menya Byinshi
                <ArrowRight className="ml-3" size={24} />
              </Link>
