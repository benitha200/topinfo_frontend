        ...
        <div className="p-6 space-y-6">
            ...
            <div className="flex justify-between items-center">
                ...
                <div className="flex items-center space-x-2">
                    ...
                    <button className="px-4 py-2 bg-slate-500 text-white rounded hover:bg-slate-600 flex items-center gap-2">
                        ...
                        <div className="flex flex-col md:flex-row space-y-2 md:space-y-0 md:space-x-2 items-start md:items-center w-full md:w-auto">
                            ...
                            <div className="relative w-full md:w-auto">
                                ...
                                <input
                                    type="text"
                                    placeholder="Search providers..."
                                    className="w-full pl-8 pr-4 py-2 border rounded focus:outline-none focus:ring-2 focus:ring-slate-500"
                                    value={searchTerm}
