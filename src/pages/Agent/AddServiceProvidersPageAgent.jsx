            ...
            <div className="min-h-screen bg-gray-50 py-8 px-4 sm:px-6 lg:px-8">
                <div className="max-w-2xl mx-auto">
                    <div className="text-center mb-8">
                        <h1 className="text-3xl font-bold text-gray-900 mb-2">Andikisha Utanga service</h1>
                        <p className="text-gray-600">Uzuza form ikurikira kugirango wandikishe utanga serivisi biciye muri topInfo</p>
                    </div>
                    ...
                    {showSuccess && (
                        <div className="mb-6 bg-green-50 border border-green-200 rounded-lg p-4 flex items-start">
                            ...
                            <div>
                                ...
                                <p className="text-green-700">Serivisi yawe yoherejwe neza. Murakoze gukoresha Topinfo!</p>
                            </div>
                        </div>
                    )}
